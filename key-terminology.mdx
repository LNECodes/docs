...
Any blockchain that is compatible with Ethereum. There are over 300 chains, including Base, Optimism, Arbitrum, and Polygon. Loop supports any EVM-compatible blockchain, including Solana and Tron. You can find a list [<u>here</u>](https://www.coincarp.com/chainlist/) of all EVM-compatible chains but please reach out if you have any questions.
...
<Card title="Getting a crypto wallet to test" icon="wallet" href="[resources]/walletTesting">
