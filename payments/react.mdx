...
```typescript PayInStateChangeEventIdle
...
```typescript PayInStateChangeEventConfirmingBalance
...
```typescript PayInStateChangeEventConfirmingAuthorization
...
```typescript PayInStateChangeEventUpdatingAuthorization
...
```typescript PayInStateChangeEventAuthorized
interface PayInStateChangeEventAuthorized {
}
```


```typescript PayInStateChangeEventSigningMessage
...
```typescript PayInStateChangeEventCreatingPaymentMethod
interface PayInStateChangeEventCreatingPaymentMethod {
    token: {
        name: string;
        logoUrl: string;
        symbol: string;
...
```typescript PayInStateChangeEventCreatingCustomer
...
```typescript PayInStateChangeEventCreatingPayment
...
```typescript PayInStateChangeEventConfirmingPayment
...
```typescript PayInStateChangeEventComplete
