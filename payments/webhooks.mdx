...
Before you can verify signatures, you need to retrieve your endpoint’s secret from [<u>get secret</u>](https://docs.loopcrypto.xyz/reference/getwebhooksecretroute#/) endpoint.
